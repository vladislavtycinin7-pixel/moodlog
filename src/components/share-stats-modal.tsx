...
export default function ShareStatsModal() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-xl sm:text-2xl font-medium tracking-[-0.5px] mb-2 text-white">
        Статистика
      </h2>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-xl p-4 mb-4">
            <div className="grid grid-cols-3 gap-3 text-center mb-3">
              <div>
                ...
                <div className="text-[10px] text-white/40 uppercase tracking-wider">Записей</div>
              </div>
              <div>
                <div className="text-xl font-semibold text-purple-500">{stats.avgMood}</div>
                <div className="text-[10px] text-white/40 uppercase tracking-wider">Среднее</div>
              </div>
              <div>
                <div className="text-xl font-semibold text-purple-500">{stats.currentStreak}</div>
                <div className="text-[10px] text-white/40 uppercase tracking-wider">Серия</div>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex-1">
              <div className="text-sm text-white/90 font-medium">Скачать JSON</div>
              <div className="text-[11px] text-white/40">Структурированные данные</div>
            </div>
          ...
          >
            ...
            <div className="flex-1">
              <div className="text-sm text-white/90 font-medium">Скачать CSV</div>
              <div className="text-[11px] text-white/40">Для таблиц и Excel</div>
            </div>
            <Download className="w-4 h-4 text-white/30" />
          </button>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-[11px] text-white/40">Форматированный текст в буфер</div>
            </div>
          </button>
          ...
          {typeof navigator !== 'undefined' && typeof navigator.share === 'function' && (
            ...
            >
              ...
              <div className="flex-1">
                <div className="text-sm text-white/90 font-medium">Поделиться</div>
                <div className="text-[11px] text-white/40">Через системное меню</div>
              </div>
            </button>
          )}
        </div>
        ...
        <div className="space-y-4">
          {!shareToken ? (
            <div className="text-center py-6">
              ...
              <p className="text-xs text-white/40 mb-6 max-w-[280px] mx-auto leading-relaxed">
              ...
              <button
                ...
                className="px-6 py-3 bg-purple-500 border-none text-white text-sm font-medium cursor-pointer transition-colors hover:bg-purple-600 disabled:opacity-60 disabled:cursor-not-allowed rounded-lg"
              >
                {shareLoading ? (
            ...
            <>
              ...
              <div className="bg-white/[0.03] border border-white/[0.08] rounded-xl p-3">
                <div className="text-[11px] text-white/40 mb-1.5 uppercase tracking-wider">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    readOnly
                    value={shareUrl}
                    className="flex-1 bg-transparent border-none text-sm text-white/70 font-mono truncate p-0 outline-none"
                  />
                  <button
